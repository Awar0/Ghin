...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=khanthesi')
	elif gh =='0':
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923329433808?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
